...
// ----------------------------------------------------------------
	...
	var blockchains = document.querySelectorAll(".blockchain");
	var games = document.querySelectorAll(".game");
	var opensources = document.querySelectorAll(".opensource");
...
tabs.forEach((tab)=>{
	tab.addEventListener("click", ()=>{
		...
		else if(tabval == "opensource"){
			opensources.forEach((opensource)=>{
